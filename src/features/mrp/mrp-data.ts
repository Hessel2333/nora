...
const BASE_NODES: BaseNode[] = [
  ...
  { id: "dish-gongbao", name: "宫保鸡丁净菜包", code: "CP0001", type: "dish", amount: 1200, unit: "份", x: 288, y: 132, width: 204, height: 86, status: "normal", description: "肉类净菜包 · BOM V2.1" },
  { id: "dish-yuxiang", name: "鱼香肉丝净菜包", code: "CP0002", type: "dish", amount: 800, unit: "份", x: 288, y: 424, width: 204, height: 86, status: "normal", description: "肉类净菜包 · BOM V1.8" },
  ...
  { id: "semi-gongbao-sauce", name: "宫保调味料包", code: "SF02008", type: "semi", amount: 72, unit: "kg", x: 566, y: 188, width: 212, height: 86, status: "normal", yieldRate: 0.96, unitCost: 18.4, description: "称量组配区 · 独立料包" },
  ...
  { id: "semi-yuxiang-sauce", name: "鱼香调味料包", code: "SF02011", type: "semi", amount: 56, unit: "kg", x: 566, y: 534, width: 212, height: 86, status: "normal", yieldRate: 0.96, unitCost: 17.8, description: "称量组配区 · 独立料包" },
...
function createBaseRows(factor: number, scenario: OrderScenario): BomTableRow[] {
  ...
  return childCountByParent([
    ...
    row("row-gongbao", "dish-gongbao", "row-order", 1, "宫保鸡丁净菜包", "CP0001", "dish", 1200, 1200, "份", 1, null, null, 18.62, "订单明细 × 标准份量"),
    ...
    row("row-gongbao-sauce", "semi-gongbao-sauce", "row-gongbao", 2, "宫保调味料包", "SF02008", "semi", 72, 72, "kg", 0.96, 22, 2, 18.4, "1,200份 × 0.060kg"),
    ...
    row("row-yuxiang", "dish-yuxiang", "row-order", 1, "鱼香肉丝净菜包", "CP0002", "dish", 800, 800, "份", 1, null, null, 16.8, "订单明细 × 标准份量"),
    ...
    row("row-yuxiang-sauce", "semi-yuxiang-sauce", "row-yuxiang", 2, "鱼香调味料包", "SF02011", "semi", 56, 56, "kg", 0.96, 18, 4, 17.8, "800份 × 0.070kg"),
...
const BASE_MATERIALS: DemandMaterial[] = [
  { id: "raw-chicken", code: "RM01234", name: "冷冻鸡胸肉", category: "禽肉类", unit: "kg", demand: 476, onHand: 360, allocated: 42, unitCost: 20.7, leadTime: "4小时", contributions: [{ id: "c-chicken-gongbao", source: "宫保鸡丁净菜包", amount: 476, orderCount: 3, formula: "2,100份 × 标准净用量 ÷ 88%" }] },
  { id: "raw-pork", code: "RM01108", name: "冷鲜猪后腿肉", category: "畜肉类", unit: "kg", demand: 340, onHand: 438, allocated: 48, unitCost: 19.6, leadTime: "6小时", contributions: [{ id: "c-pork-yuxiang", source: "鱼香肉丝净菜包", amount: 340, orderCount: 3, formula: "1,900份 × 标准净用量 ÷ 88%" }] },
  { id: "raw-peanut", code: "RM03108", name: "花生米", category: "干货类", unit: "kg", demand: 84, onHand: 66, allocated: 10, unitCost: 14, leadTime: "1天", contributions: [{ id: "c-peanut-gongbao", source: "宫保鸡丁净菜包", amount: 84, orderCount: 3, formula: "2,100份 × 0.0392kg ÷ 98%" }] },
  { id: "raw-carrot", code: "RM02032", name: "胡萝卜", category: "根茎类", unit: "kg", demand: 265, onHand: 216, allocated: 28, unitCost: 4.2, leadTime: "3小时", contributions: [{ id: "c-carrot-yuxiang", source: "鱼香肉丝净菜包", amount: 120, orderCount: 3, formula: "1,900份 × 鱼香配菜标准" }, { id: "c-carrot-veg", source: "时蔬净菜包", amount: 145, orderCount: 2, formula: "1,600份 × 净配时蔬标准" }] },
  { id: "raw-fungus", code: "RM02128", name: "水发木耳", category: "菌菇类", unit: "kg", demand: 72, onHand: 108, allocated: 18, unitCost: 9.8, leadTime: "4小时", contributions: [{ id: "c-fungus-yuxiang", source: "鱼香肉丝净菜包", amount: 72, orderCount: 3, formula: "1,900份 × 鱼香配菜标准" }] },
  { id: "raw-greens", code: "RM02086", name: "上海青", category: "叶菜类", unit: "kg", demand: 310, onHand: 296, allocated: 36, unitCost: 5.6, leadTime: "2小时", contributions: [{ id: "c-greens-veg", source: "时蔬净菜包", amount: 310, orderCount: 2, formula: "1,600份 × 净配时蔬标准" }] },
  { id: "raw-garlic", code: "RM03004", name: "葱姜蒜净料", category: "净配调料", unit: "kg", demand: 96, onHand: 106, allocated: 24, unitCost: 11.2, leadTime: "3小时", contributions: [{ id: "c-garlic-gongbao", source: "宫保调味料包", amount: 30, orderCount: 3, formula: "宫保调味料包 × 46.2%" }, { id: "c-garlic-yuxiang", source: "鱼香调味料包", amount: 32, orderCount: 3, formula: "鱼香调味料包 × 44.4%" }, { id: "c-garlic-veg", source: "时蔬调味料包", amount: 34, orderCount: 2, formula: "时蔬调味料包 × 53.1%" }] },
  { id: "raw-sauce", code: "RM03026", name: "复合酱汁基料", category: "复合调料", unit: "kg", demand: 105, onHand: 188, allocated: 28, unitCost: 13.8, leadTime: "1天", contributions: [{ id: "c-sauce-gongbao", source: "宫保调味料包", amount: 35, orderCount: 3, formula: "宫保调味料包 × 53.8%" }, { id: "c-sauce-yuxiang", source: "鱼香调味料包", amount: 40, orderCount: 3, formula: "鱼香调味料包 × 55.6%" }, { id: "c-sauce-veg", source: "时蔬调味料包", amount: 30, orderCount: 2, formula: "时蔬调味料包 × 46.9%" }] },
  { id: "packaging", code: "PK0008", name: "标准净菜包装套装", category: "包装物", unit: "套", demand: 5600, onHand: 4500, allocated: 600, unitCost: 1.46, leadTime: "2天", excludedFromWeightFlow: true, contributions: [{ id: "c-packaging-gongbao", source: "宫保鸡丁净菜包", amount: 2100, orderCount: 3, formula: "净菜包 1份 × 1套" }, { id: "c-packaging-yuxiang", source: "鱼香肉丝净菜包", amount: 1900, orderCount: 3, formula: "净菜包 1份 × 1套" }, { id: "c-packaging-veg", source: "时蔬净菜包", amount: 1600, orderCount: 2, formula: "净菜包 1份 × 1套" }] },
];

const BASE_SANKEY_NODES: SankeyNode[] = [
  { name: "8月6日订单", depth: 0, itemStyle: { color: "#1768f2" } },
  { name: "宫保鸡丁净菜包", depth: 1, itemStyle: { color: "#5b8ff9" } },
  { name: "鱼香肉丝净菜包", depth: 1, itemStyle: { color: "#6858e8" } },
  { name: "时蔬净菜包", depth: 1, itemStyle: { color: "#08a879" } },
  { name: "鸡丁预处理", depth: 2, itemStyle: { color: "#7aa8fb" } },
  { name: "宫保调味料包", depth: 2, itemStyle: { color: "#7aa8fb" } },
  { name: "肉丝预处理", depth: 2, itemStyle: { color: "#8d82ec" } },
  { name: "鱼香配菜", depth: 2, itemStyle: { color: "#8d82ec" } },
  { name: "鱼香调味料包", depth: 2, itemStyle: { color: "#8d82ec" } },
  { name: "净配时蔬", depth: 2, itemStyle: { color: "#4fc5a2" } },
  { name: "时蔬调味料包", depth: 2, itemStyle: { color: "#4fc5a2" } },
...
const BASE_SANKEY_LINKS: SankeyLink[] = [
  { source: "8月6日订单", target: "宫保鸡丁净菜包", value: 625 },
  { source: "8月6日订单", target: "鱼香肉丝净菜包", value: 604 },
  { source: "8月6日订单", target: "时蔬净菜包", value: 519 },
  { source: "宫保鸡丁净菜包", target: "鸡丁预处理", value: 476 },
  { source: "宫保鸡丁净菜包", target: "宫保调味料包", value: 65 },
  { source: "宫保鸡丁净菜包", target: "花生米", value: 84 },
  { source: "鸡丁预处理", target: "冷冻鸡胸肉", value: 476 },
  { source: "宫保调味料包", target: "葱姜蒜净料", value: 30 },
  { source: "宫保调味料包", target: "复合酱汁基料", value: 35 },
  { source: "鱼香肉丝净菜包", target: "肉丝预处理", value: 340 },
  { source: "鱼香肉丝净菜包", target: "鱼香配菜", value: 192 },
  { source: "鱼香肉丝净菜包", target: "鱼香调味料包", value: 72 },
  { source: "肉丝预处理", target: "冷鲜猪后腿肉", value: 340 },
  { source: "鱼香配菜", target: "胡萝卜", value: 120 },
  { source: "鱼香配菜", target: "水发木耳", value: 72 },
  { source: "鱼香调味料包", target: "葱姜蒜净料", value: 32 },
  { source: "鱼香调味料包", target: "复合酱汁基料", value: 40 },
  { source: "时蔬净菜包", target: "净配时蔬", value: 455 },
  { source: "时蔬净菜包", target: "时蔬调味料包", value: 64 },
  { source: "净配时蔬", target: "胡萝卜", value: 145 },
  { source: "净配时蔬", target: "上海青", value: 310 },
  { source: "时蔬调味料包", target: "葱姜蒜净料", value: 34 },
  { source: "时蔬调味料包", target: "复合酱汁基料", value: 30 },
];
