...
const ROOM_DEFINITIONS: FactoryRoomDefinition[] = [
  ...
  { id: "R03+R06", name: "蔬菜内包装间", zoneId: "vegetable-packing", temperature: "12.4°C", humidity: "50%RH", owner: "陈勇", equipment: "双室真空包装机", primaryMetric: "task", task: staticTask("DEMO-WO-002", "鱼香肉丝内包装", "待到站", "warning", 0, "1,500 份", "11:10") },
  ...
  { id: "R10", name: "配料间", status: "running", temperature: "15.8°C", humidity: "48%RH", owner: "周敏", equipment: "电子秤、调味料架、配料台", primaryMetric: "task", task: staticTask("DEMO-WO-006", "宫保调味汁称量", "进行中", "info", 42, "320 kg", "10:45") },
  { id: "R11", name: "冷藏库", status: "normal", temperature: "2.8°C", humidity: "46%RH", owner: "李婷", equipment: "冷藏机组 CL-01", primaryMetric: "environment", task: staticTask("DEMO-QC-011", "冷藏库温控巡检", "已完成", "success", 100, undefined, "09:30") },
  { id: "R12", name: "冷冻库", status: "normal", temperature: "-18.2°C", humidity: "42%RH", owner: "李婷", equipment: "冷冻机组 FZ-01", primaryMetric: "environment", task: staticTask("DEMO-QC-012", "冷冻库温控巡检", "已完成", "success", 100, undefined, "09:35") },
  { id: "R13", name: "包材库", status: "normal", temperature: "21.4°C", humidity: "44%RH", owner: "赵敏", equipment: "货架、除湿机", primaryMetric: "inventory", primaryLabel: "库存 68%", task: staticTask("DEMO-PD-013", "午间包材备料", "进行中", "info", 66, "4,200 套", "10:50") },
  { id: "R14", name: "0–4°C冷藏库", zoneId: "cold-chain", status: "warning", temperature: "4.8°C", humidity: "54%RH", owner: "李婷", equipment: "冷藏机组 CL-02", primaryMetric: "environment", alert: { title: "温度接近上限", detail: "当前 4.8°C，建议检查库门与制冷机组", tone: "warning" }, task: staticTask("DEMO-QC-014", "冷链温控复核", "待处理", "warning", 35, undefined, "10:20") },
  { id: "R15", name: "肉类前处理加工", zoneId: "meat-prep", temperature: "12.4°C", humidity: "55%RH", owner: "王强", equipment: "解冻池、工作台、杀鱼台", primaryMetric: "task", task: staticTask("DEMO-WO-003", "宫保鸡丁肉类前处理", "进行中", "info", 68, "2,000 份", "10:05") },
  ...
  { id: "R21", name: "发货缓冲区", zoneId: "dispatch", temperature: "18°C", humidity: "52%RH", owner: "陈凯", equipment: "发货缓冲台与货梯", primaryMetric: "fulfillment", task: staticTask("DEMO-SO-0048", "华润万家订单出库复核", "进行中", "info", 70, "2,000 份", "11:00") },
];
